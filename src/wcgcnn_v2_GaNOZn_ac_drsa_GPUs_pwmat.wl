...
actionSpace=Block[
	{a,b,c,d,l1,l2},
	{a,b,c,d}=Range[72]//Partition[#,18]&;
	l1=Table[{i,j},{i,a},{j,b}]//Flatten[#,1]&;
	l2=Table[{i,j},{i,c},{j,d}]//Flatten[#,1]&;
	Join[l1,l2]
];
...
pos2coor=Compile[{{poslist,_Real,1},{sort,_Integer,1},{inicoor,_Real,2}},
	Block[{a,b,c,d,s,l1,l2},
		{a,b,c,d}=Partition[inicoor,18];
		l1={a,b,c,d}[[sort]]//Flatten[#,1]&;
		l2=l1[[Round@poslist]]//Partition[#,18]&;
		s=Ordering[sort];
		l2[[s]]//Flatten[#,1]&
	],
	CompilationTarget->"C",RuntimeOptions->"Speed",
